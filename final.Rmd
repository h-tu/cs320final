...
To find the relationship between those stats and the winning percentage. We have to first add a column contains the winning percentage. We use the formula Win/(Win+Lose) to find the winning percentage.
```{r}
